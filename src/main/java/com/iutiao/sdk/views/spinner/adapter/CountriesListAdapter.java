package com.iutiao.sdk.views.spinner.adapter;
...
public class CountriesListAdapter extends ArrayAdapter<String> {
    ...
    public CountriesListAdapter(Context context, String[] values) {
        super(context, R.layout.com_iutiao_spinner_country_list_item, values);
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.com_iutiao_spinner_country_list_item, parent, false);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.com_iutiao_spinner_country_selected_item, parent, false);
